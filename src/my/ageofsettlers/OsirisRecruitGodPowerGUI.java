 ...
 */
public class OsirisRecruitGodPowerGUI extends javax.swing.JFrame {

    /**
     * Creates new form OsirisRecruitGodPowerGUI
     */
    public OsirisRecruitGodPowerGUI() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OsirisRecruitGodPowerGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OsirisRecruitGodPowerGUI().setVisible(true);
            }
        });
    }

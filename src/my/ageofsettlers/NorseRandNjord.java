 ...
 */
public class NorseRandNjord extends javax.swing.JFrame {

    /**
     * Creates new form NorseRandNjord
     */
    public NorseRandNjord() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NorseRandNjord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NorseRandNjord().setVisible(true);
            }
        });
    }
    Norse nPlayer;

 ...
 */
public class TradeLokiFromGreekGUI extends javax.swing.JFrame {

    /**
     * Creates new form TradeLokiFromGreekGUI
     */
    public TradeLokiFromGreekGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select any 5 resources of Greeks to steal");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(sum1 == sum2) {
            Greek gPlayer = Greek.getInstance();
            gPlayer.setFood(gPlayer.getFood() - playerFoodCount);
            gPlayer.setFavor(gPlayer.getFavor() - playerFavorCount);
            gPlayer.setWood(gPlayer.getWood() - playerWoodCount);
            gPlayer.setGold(gPlayer.getGold() - playerGoldCount);
        ...
        public void setupTradeCostGUI(String culture) {
            ...
            Greek gPlayer = Greek.getInstance();
            foodCount = new String[gPlayer.getFood()+1];
            favorCount = new String[gPlayer.getFavor()+1];
            woodCount = new String[gPlayer.getWood()+1];
            goldCount = new String[gPlayer.getGold()+1];
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TradeLokiFromGreekGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TradeLokiFromGreekGUI().setVisible(true);
            }
        });
    }

 ...
 */
public class GodPowerZeusGUI extends javax.swing.JFrame {

    /**
     * Creates new form GodPowerZeusGUI
     */
    public GodPowerZeusGUI() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Do you want to use God Power for Zeus ?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (greekPlayer.getFavor() > 1) {
            greekPlayer.setFavor(greekPlayer.getFavor() - 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GodPowerZeusGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GodPowerZeusGUI().setVisible(true);
            }
        });
    }
    Greek greekPlayer;

 ...
 */
public class EgyptBuildTah extends javax.swing.JFrame {

    /**
     * Creates new form EgyptBuildTah
     */
    public EgyptBuildTah() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EgyptBuildTah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EgyptBuildTah().setVisible(true);
            }
        });
    }
    Egyptian ePlayer;

 ...
 */
public class TradeLokiGUI extends javax.swing.JFrame {

    /**
     * Creates new form TradeLokiGUI
     */
    public TradeLokiGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select an opponent to steal 5 of his resources");
    ...
    private void egyptianButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_egyptianButtonActionPerformed
        TradeLokiFromEgyptianGUI loki = new TradeLokiFromEgyptianGUI();
        loki.setVisible(true);
        loki.setupTradeCostGUI("Norse");
    ...
    private void greekButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_greekButtonActionPerformed
        TradeLokiFromGreekGUI loki = new TradeLokiFromGreekGUI();
        loki.setVisible(true);
        loki.setupTradeCostGUI("Norse");
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TradeLokiGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TradeLokiGUI().setVisible(true);
            }
        });
    }
